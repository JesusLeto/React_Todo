...
const Task = ({OnClick, TaskObj, activeClass}) => {

    return(        
            <li onClick = {OnClick} key = {TaskObj.id} className = {`Theme ${activeClass}`}>          
                    <div className = "Circle" style = {{backgroundColor: TaskObj.color}}></div>
                    <p>{TaskObj.Name}</p>
