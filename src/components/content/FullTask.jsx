...
const FullTask = ({NameHeader, ColorTask}) => {
    ...
    return (
        <div className = "FullTask">
            ...
            <FullTaskMenu NameHeaderTask = {NameHeader}/>

            <div className = "FullTask__interactive">
                {!showTextTask && <span className = "FullTask__addNew" onClick = {() => setshowTextTask(true)}>
                ...
                {showTextTask && <span className = "FullTask__FulladdNew">
                    <input type="text" className = "FullTask__input" placeholder = "Текст задачи"/>
                    <button className = "FullTask__BTN FullTask__addBTN">Добавить задачу</button>
                    <button className = "FullTask__BTN FullTask__cancelBTN" onClick = {() => setshowTextTask(false)}>Отмена</button>
                    </span>}
            </div>
        </div>
    )
