...
const Themes = ({OnClick, ThemeObj, activeClass, OnRemove}) => {
    return(        
            <li onClick = {OnClick} key = {ThemeObj.id} className = {`Theme ${activeClass}`}>          
                    <div className = "Circle" style = {{backgroundColor: ThemeObj.color.hex}}></div>
                    <p>{ThemeObj.Name}</p>
                    {activeClass && <svg onClick = {() => OnRemove(ThemeObj)} width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
